...
class Capability : public fbl::RefCounted<Capability>,
                   public fbl::DoublyLinkedListable<fbl::RefPtr<Capability>> {
public:
...
using CapabilityList = fbl::DoublyLinkedList<fbl::RefPtr<Capability>>;
...
// the specific register's offset.
class ExtCapability : public fbl::RefCounted<ExtCapability>,
                      public fbl::DoublyLinkedListable<fbl::RefPtr<ExtCapability>> {
public:
...
using ExtCapabilityList = fbl::DoublyLinkedList<fbl::RefPtr<ExtCapability>>;
